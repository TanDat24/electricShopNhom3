...
const ProductDetail = () => {
    ...
    const product = {
        id: "1",
        name: "Laptop RogStrix G18 a b c d e f g h i j k l m n i u h u n i v e r s i t y",
        rating: 4.8,
        reviews: "1k",
        price: 20000000,
        ...
        remaining: "00:00:00",
        images: {
            black: "https://vn.store.asus.com/media/catalog/product/cache/3bea06a8f9af12bff161ee6fdcaca509/g/8/g814ji-n6063w.png",
            white: "https://lapvip.vn/upload/file/original/asus-rog-zephyrus-g14-2024-3-1714811607.jpg",
            redBlack:
                    ...
                    <div className="options-section">
                        <div className="color-options">
                            ...
                            <div className="colors-row">
                                ...
                                <button
                                    onClick={() =>
                                        handleColorChange("redBlack")
                                    }
                                    className={`color-option ${
                                        selectedColor === "redBlack"
                                            ? "selected"
                                            : ""
                                    }`}
                                >
