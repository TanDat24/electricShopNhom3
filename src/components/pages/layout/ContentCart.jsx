...
const ContentCart = ({ title, des, name, id }) => {
    return (
            ...
            <div className="bg-white p-4 rounded-xl cursor-pointer">
                <div className="grid grid-cols-11 gap-2 h-1/2">
                    <div className="col-span-5 bg-white ">
                        <img
                            src={images.watchUltimateCard1}
                            className="rounded-lg h-[500px]"
                        />
                    </div>
                    <div className="col-span-3 bg-white relative">
                        <BannerText text="Vật Liêu Kim Loại Lỏng" />
                        <img
                            src={images.watchUltimateCard2}
                            className="rounded-lg h-[500px]"
                        />
                    </div>
