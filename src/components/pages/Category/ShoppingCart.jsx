...
const ShoppingCart = () => {
  ...
  setTimeout(() => {
    navigate("/vn/category"); // Điều hướng sau khi state cập nhật
  }, 100); 
      ...
      <div className="flex flex-col lg:flex-row gap-16  pt-6">
        ...
        <div className="w-full lg:w-3/5 space-y-6">
          <div className="grid grid-cols-5 font-semibold text-gray-700 bg-gray-100 p-3 rounded-md">
            ...
            <span className="pl-6 ">Giá</span>
            <span className="pl-20 ml-4 ">Số lượng</span>
          </div>
          {cartItems.length === 0 ? (
        ...
        <div className="w-full lg:w-2/5 p-6 pb-4 border rounded-lg shadow-md bg-white h-fit">
          ...
          <button onClick={ handleCheckout} className="w-full mt-6 bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 text-lg font-semibold">
            Thanh toán
          </button>
          <div
