    ...
    <div className="flex items-center justify-start">
      <div className="flex items-center justify-start h-full w-full">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-medium mt-4">HUAWEI MatePad 11.5"S</h1>
          ...
          <div className="w-[240px] mt-6 mx-auto space-y-4">
            <div className="pt-4 pb-4">
              ...
              <div>
                Khoảng 508 g (bao gồm pin) Màn hình Tandem OLED PaperMatte 2800
                × 1840, 274 ppi
              </div>
            </div>
            ...
            <div className="w-[240px] mt-6 mx-auto space-y-4">
              ...
              <div>Camera cảm biến thông minh (Khẩu độ f/2.0, FF)</div>
            </div>
            <div className="w-[240px] mt-6 mx-auto space-y-4">
              <svg
                className="w-10 h-10 w-[240px] mt-6 mx-auto space-y-4"
